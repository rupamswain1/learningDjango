...
SECRET_KEY = ')i7ubs34!^q7y&ntt-cv-)6%b2hhd^(5rskopke)gd9-9x&#0h'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR,'template'),os.path.join(BASE_DIR,'travelWebsiteTemplate')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATIC_URL = '/static/'
STATICFILES_DIRS=[
    os.path.join(BASE_DIR,'travelWebsiteTemplate')
